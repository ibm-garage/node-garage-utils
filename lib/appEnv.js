...
function isSpec() {
  ...
  return (
    endsWith(mainFile, path.sep + "_mocha") ||
    endsWith(mainFile, ".spec.js") ||
    endsWith(mainFile, "_spec.js") ||
    endsWith(mainFile, ".test.js") ||
    endsWith(mainFile, "_test.js")
  );
}
...
function isScript() {
  ...
  return (
    startsWith(mainFile, moduleBinDir) ||
    startsWith(mainFile, path.join(appEnv.rootDir, "bin")) ||
    startsWith(mainFile, path.join(appEnv.rootDir, "scripts"))
  );
}
