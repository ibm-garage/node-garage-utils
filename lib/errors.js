// Creates and returns errors of a consistent format that's expected by the
// app's error handlers. Route implementations should use these functions,
// optionally wrapping any errors received from lower levels.
